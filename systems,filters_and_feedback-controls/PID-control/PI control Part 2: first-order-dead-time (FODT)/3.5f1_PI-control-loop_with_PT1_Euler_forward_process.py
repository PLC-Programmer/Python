...
for k in range(1,STEPS):
    ...
    if k < STEPS-1:
        ...
        # ...
        x1_KJA[k+1] = (1 - a0*h/a1)*x1_KJA[k] + b0/a1*h*u_KJA[k]

        # x1_KJA[k] = x1_KJA[k] * x1_KJA_noise[k]
...
plt.suptitle('Simulation of PI controller with a PT1 process', y = 1.0)
plt.title('process: b0=1.0, a0=1.0, a1=1.0 [sec] (Euler forward)', y = 1.0)
...
\nKp={Kp_KJA:.4f},Tn={Tn:.4f} (lambda tuning rules)\
...
# end of 3.5f1_PI-control-loop_with_PT1_Euler_forward_process.py
